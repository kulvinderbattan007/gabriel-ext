...
// console.log("budgetValue", handle); 
if (selectedValue) {
if (user_price != '') {
...
return;
var post_url = mainpath + '/ShopifyFront/GetProductDetailsModal'+'?shape=' + shap + '&stones=' + stones + '&user_price=' + user_price + '&product_id=' + product_id + '&type_choosen=' + selectedValue.value + '&product_price=' + product_price + '&search_type=' + search_type + '&handle=' + handle+ '&shopurl=' + shopurl + '&page=1&theme=default'+ '&ratio='+selectedValue.value;
$.ajax({
url: post_url,
type: "GET",                        
success: function (response) {
...
$('.templateProduct .mar_bottom').css('margin-bottom', divheight);
}
if (w < 768) {
$('.custom-left-show').hide();
$('.custom-left').show();
